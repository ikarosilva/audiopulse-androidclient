...
public abstract class ProcedureElement {
    ...
    protected void populateElementAttributeMap(Map<String,String> elementAttributeMap) {
    	elementAttributeMap.put("question", getQuestion());
    	elementAttributeMap.put("answer", getAnswer());
    	elementAttributeMap.put("type", getType().toString());
    	elementAttributeMap.put("concept", getConcept());
    }
    ...
    public static ProcedureElement createElementfromXML(Node node) throws ProcedureParseException {
        ...
        case DATE:
        	...
        	break;
        case CAPTURE:
        	el = CaptureElement.fromXML(idStr, questionStr, answerStr, conceptStr, figureStr, audioStr, node);
        	break;
        case FUNCEVAL:
        	el = FUNCEVALElement.fromXML(idStr, questionStr, answerStr, conceptStr, figureStr, audioStr, node);
        	break;
        case INVALID:
        default:

...
public class FUNCEVALElement extends ProcedureElement implements  OnClickListener, OnItemClickListener, OnItemLongClickListener {
	 ...
	 public static final String PARAMS_NAME = "keys";
	    ...
	    private Button funcevalButton;
	    private GridView imageGrid;
	    private String mContentType;

	    @Override
	    public ElementType getType() {
	        return ElementType.FUNCEVAL;
	    }

	    /**
	     * Do not call this method! It's called /if/ FUNCEVALElement becomes activated for display.
	     */
	    @Override
	    protected View createView(Context c) {
	        ...
	        funcevalButton = new Button(c);
	        funcevalButton.setText("Perform Test");
	        funcevalButton.setOnClickListener(this);
	        
	        new ImagePreviewDialog(c);
	        ...
	        //Add button
	        picContainer.addView(funcevalButton, new LinearLayout.LayoutParams(-1,-1,0.1f));
	    ...
	    // ProcedureRunner.
		 public void onClick(View v) {
			 if (v == funcevalButton) {
				 ...
				 Intent funcevalIntent = new Intent(getContext(), ProcedureRunner.class);
				 funcevalIntent.putExtra(PARAMS_NAME, params)
				 			  .addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP)
				              .putExtra("intentKey", ProcedureRunner.FUNCTIONEVAL_INTENT_REQUEST_CODE);
				 funcevalIntent.setType(mContentType);
				 ((Activity) getContext()).startActivity(funcevalIntent);
			 }
		 }
...
//	        return iadapter.getItemId(selected) + "";
	    ...
	    private FUNCEVALElement(String id, String question, String answer, String concept, String figure, String audio, String contentType) {
	     ...
	     */
	    public static FUNCEVALElement fromXML(String id, String question, String answer, String concept, String figure, String audio, Node node) throws ProcedureParseException {
	    	String contentType = MocaUtil.getNodeAttributeOrFail(node, "content-type", new ProcedureParseException("Required attribute 'content-type' not provided for FUNCEVAL element."));
	        return new FUNCEVALElement(id, question, answer, concept, figure, audio, contentType);
	    }

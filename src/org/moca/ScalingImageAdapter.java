...
public class ScalingImageAdapter extends CursorAdapter {
    ...
    private ThumbUriAdapter mUriAdapter;

    public ScalingImageAdapter(Context ctx, Cursor cur, int scaleFactor, ThumbUriAdapter uriAdapter) {
        super(ctx,cur);
    ...
    private Uri getImageThumbnailUriFromCursorRow(Cursor cursor) {
        ...
        return mUriAdapter.getThumbnailUri(uri);
    }

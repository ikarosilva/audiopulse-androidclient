...
public final class MocaDB {
    ...
    public static final String BINARY_AUTHORITY = "org.moca.provider.Binary";
    public static final String FUNCEVAL_AUTHORITY = "org.moca.provider.FUNCEVAL";
    ...
    public static final int DATABASE_VERSION = 3; // Reset this to 1 before release
...
//        
    ...
    public static final class BinarySQLFormat implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/org.moca.binary";

        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/org.moca.binary";

        public static final String DEFAULT_SORT_ORDER = "modified DESC";

        // COLUMNS
        
        public static final String ENCOUNTER_GUID = "encounter_guid";
        
        public static final String ELEMENT_ID = "element_id";
        
        // Is the file written completely to storage yet? 
        public static final String BINARY_VALID = "binary_valid";
        
        public static final String BINARY_CONTENT_TYPE = "binary_content_type";
        
        // How many bytes have been uploaded 
        public static final String UPLOAD_PROGRESS = "upload_progress";
        
        // Whether or not the file has been uploaded yet
        public static final String UPLOADED = "uploaded";
    ...
    public static final class FUNCEVALSQLFormat implements BaseColumns {
    	private FUNCEVALSQLFormat() {
        }

        public static final Uri CONTENT_URI = Uri.parse("content://"
                + FUNCEVAL_AUTHORITY + "/funceval");

        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/org.moca.funceval";

        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/org.moca.funceval";
        ...
        // Is the file written completely to storage yet? 
        public static final String FUNCEVAL_VALID = "funceval_valid";
        
        public static final String FUNCEVAL_CONTENT_TYPE = "funceval_content_type";
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            FUNCEVALProvider.onCreateDatabase(db);
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            FUNCEVALProvider.onUpgradeDatabase(db, oldVersion, newVersion);

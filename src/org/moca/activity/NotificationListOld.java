 ...
 * NotificationViewer.
 */
public class NotificationListOld extends ListActivity implements SimpleCursorAdapter.ViewBinder {
	private static final String TAG = NotificationListOld.class.toString();

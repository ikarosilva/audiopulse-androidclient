...
public class OldDPOAEProcedure extends TestProcedure {
	private LinkedList<DPOAEParameters> testList = new LinkedList<OldDPOAEProcedure.DPOAEParameters>();
	
	public OldDPOAEProcedure(TestActivity parent) {
		super(parent);
		TAG = "DPOAEProcedure";
